...
export class IncidentsController {
  ...
  @ApiOperation({
    ...
    description:
      'Crea un nuevo incidente de seguridad. Clasificaciones: Breach, NearMiss, SecurityEvent, PolicyViolation. HIPAA Breach Notification Rule.',
  })
  @ApiResponse({
    status: 201,
    description: 'Incidente registrado con datos del reportante',
  })
  create(@Body() dto: CreateIncidentDto, @CurrentUser() user: { id: number }) {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los incidentes de seguridad ordenados por fecha de creación descendente.',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de incidentes con usuario que reportó',
  })
  findAll() {
  ...
  @ApiOperation({
    ...
    description:
      'Modifica estado, descripción o cantidad de registros afectados. Cuando el estado cambia a Resolved o Closed se registra la fecha de resolución automáticamente. Solo ADMIN y AUDITOR.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
