...
export class PatientsController {
  ...
  @ApiOperation({
    ...
    description:
      'Registra un nuevo paciente. Los campos nombre, fecha de nacimiento y SSN se cifran con AES-256-CBC antes de almacenarse. Solo ADMIN y DOCTOR.',
  })
  @ApiResponse({ status: 201, description: 'Paciente creado exitosamente' })
  @ApiResponse({ status: 403, description: 'Permisos insuficientes' })
  create(@Body() dto: CreatePatientDto, @CurrentUser() user: { id: number }) {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna todos los pacientes activos con datos PHI descifrados. Acceso: ADMIN, DOCTOR, NURSE.',
  })
  @ApiResponse({
    status: 200,
    description: 'Lista de pacientes con datos descifrados',
  })
  findAll() {
  ...
  @ApiOperation({
    ...
    description:
      'Retorna los datos del paciente con registros médicos asociados. Datos PHI descifrados.',
  })
  @ApiParam({ name: 'id', type: Number, description: 'ID del paciente' })
  @ApiResponse({
    status: 200,
    description: 'Datos del paciente con registros médicos',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Modifica datos PHI del paciente (se recifran automáticamente). Solo ADMIN y DOCTOR.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
  ...
  @ApiOperation({
    ...
    description:
      'Marca al paciente como eliminado sin borrar físicamente el registro (retención regulatoria). Solo ADMIN.',
  })
  @ApiParam({
    name: 'id',
    type: Number,
